...
class PclBackbone(nn.Module):
    def __init__(
        ...
        self.common = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.Conv3d(in_channels=8, out_channels=16, kernel_size=3, stride=1),
            nn.LeakyReLU(),
            ...
            nn.LeakyReLU(),
            nn.Conv3d(in_channels=64, out_channels=64, kernel_size=5, stride=1),
            nn.LeakyReLU(),
        ...
        self.ft1 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=3, stride=2)
        self.ft2 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=5, stride=1)
        self.ft3 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=1, stride=1)
